...
> 3. **§5.2 路径 C 预留强化**：从"仅部署抽象"扩展为"完整演进路径"，交叉引用 `evolution-roadmap.md`。
>
> ---
> **版本**：v2（主智能体校准版）
...
> **v3 更新**：本节从"仅部署抽象"升级为"完整演进路径锚点"。详细里程碑与触发条件见 `docs/product/evolution-roadmap.md`。
...
> **v3 新增章节**。配合 PROJECT.md v4「演进蓝图」与 `evolution-roadmap.md`。
>
